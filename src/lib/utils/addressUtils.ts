 ...
 * - explorer/src/lib/utils/addressUtils.ts
 * 
 ...
 */
export function isValidAddressFormat(address: string | null | undefined): boolean {
  if (!address) {
    return false;
  }
 ...
 */
export function addressesMatch(addr1: string | null | undefined, addr2: string | null | undefined): boolean {
